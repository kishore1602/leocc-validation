...
Output: cdf_mobility_carryforward.png saved to ~/graphs/mobility/carryforward_graphs/
"""
...
fig.suptitle("CDF of Throughput and One-Way Delay — 3 Mobility Traces (Carry-Forward)",
...
plt.tight_layout()
out_path = os.path.join(OUT, "cdf_mobility_carryforward.png")
