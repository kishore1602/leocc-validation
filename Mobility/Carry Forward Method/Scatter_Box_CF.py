#!/usr/bin/env python3
"""
scatter_box_mobility_carryforward.py
======================================
Plots throughput vs one-way delay box plot across 3 mobility uplink traces
for 3 CCAs: Cubic, BBR, LeoCC (carry-forward delay method).
...
Output: scatter_box_mobility_carryforward.png saved to ~/graphs/mobility/carryforward_graphs/
"""
...
OUT  = os.path.expanduser("~/graphs/mobility/carryforward_graphs")
os.makedirs(OUT, exist_ok=True)

TRACES = [
    "1770565256238-0500",  # T1
    "1770567213734-0500",  # T8
    "1770569558888-0500",  # T16
]
...
ax.set_title("Average Throughput vs One-Way Delay — 3 Mobility Traces (Carry-Forward)",
...
plt.tight_layout()
out_path = os.path.join(OUT, "scatter_box_mobility_carryforward.png")
