#!/usr/bin/env python3
"""
cdf_mobility_seqbased.py
==========================
Plots CDF of throughput and one-way delay across 3 mobility uplink traces
...
Output: cdf_mobility_seqbased.png saved to ~/graphs/mobility/seqbased_graphs/
"""
...
fig.suptitle("CDF of Throughput and One-Way Delay — 3 Mobility Traces (Seq-Based)",
...
plt.tight_layout()
out_path = os.path.join(OUT, "cdf_mobility_seqbased.png")
