#!/usr/bin/env python3
"""
plot_mobility_seqbased.py
===================================
Plots 4-subplot performance graph for 3 mobility traces
using seq-based delay method with per-trace loss rates.
...
Output: saved to ~/graphs/mobility/seqbased_graphs/
"""
...
# Offsets in seconds, loss rates per trace
TRACES = {
    "1770565256238-0500": 3.936,    # T1
    "1770567213734-0500": 11.562,   # T8
    "1770569558888-0500": 6.639,    # T17
}
...
def plot_trace(trace_id, ul_offset):
    print(f"\n{'='*60}")
    print(f"Plotting {trace_id} [mobility seq-based]")
    ...
    fig.suptitle(
        f"Uplink Performance – Trace {trace_id} (Mobility, Seq-Based)",
    ...
    plt.tight_layout()
    out_path = os.path.join(OUT, f"{trace_id}_mobility_seqbased.png")
...
if __name__ == "__main__":
    ...
    print("\nAll plots done! Check ~/graphs/mobility/seqbased_graphs/")
