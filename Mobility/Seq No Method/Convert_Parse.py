#!/usr/bin/env python3
"""
convert_mobility_seqbased.py
=============================
Converts trimmed ICMP ping logs and UDP pcap files to mahimahi format
for all 16 good mobility traces using seq-based method.
...
Output saved to new_mahimahi_traces_mobility_seqbased/<trace_id>/uplink/:
    delay_uplink.txt
    bw_uplink.txt

Output saved to new_mahimahi_traces_mobility_seqbased/<trace_id>/downlink/:
    delay_downlink.txt
    bw_downlink.txt
"""
import os
...
OUTPUT_BASE  = "/mnt/nuwinslab_nas/nuwins_data_platform/datasets/bos_phi_trip_202601/new_mahimahi_traces_mobility_seqbased"
SCRIPT       = os.path.expanduser("~/graphs/mobility/parse_recorder_seqbased_mobility.py")
...
if __name__ == "__main__":
    ...
    print("\nAll 16 mobility traces converted (seq-based).")
