#!/usr/bin/env python3
"""
parse_recorder_carryforward_static.py
========================================
Convert LeoRecorder outputs to LeoReplayer trace format.
Carry-forward version for static traces.
...
def main():
    parser = argparse.ArgumentParser(
        description='Convert LeoRecorder outputs to LeoReplayer trace format (carry-forward static)',
    )
    ...
    print(f"Converting recorder outputs to replayer format (carry-forward static)...")
